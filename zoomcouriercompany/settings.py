"""
Django settings for zoomcouriercompany project.
...
SECRET_KEY = 'django-insecure-+*tp7*p8fvpq=wz9!pj$kbxt*1v)=it^lu(0xx#&=28!uj_^qz'
...
ROOT_URLCONF = 'zoomcouriercompany.urls'
...
WSGI_APPLICATION = 'zoomcouriercompany.wsgi.application'
